...
export const BAGEL_UPGRADES: PastryUpgrade[] = [
  {
    ...
    description:
      'A viral social media campaign makes all pastries more desirable. Global sell multiplier +50%!',
  ...
  },
  {
    ...
    description:
      'Famous chefs praise your pastries, increasing their value everywhere. Global sell multiplier +50%!',
    type: PastryUpgradeType.GlobalSellMultiplier,
    value: 1.5,
  ...
  },
  {
    ...
    description:
      'Billboards and TV spots make pastries a household name. Global sell multiplier +50%!',
    type: PastryUpgradeType.GlobalSellMultiplier,
    value: 1.5,
  ...
  },
  {
    ...
    description:
      'Your pastries are loved worldwide. Global sell multiplier +50%!',
    type: PastryUpgradeType.GlobalSellMultiplier,
    value: 1.5,
